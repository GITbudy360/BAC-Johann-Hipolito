...
\begin{description}
    ...
    \textbf{Commit-Hash:} \texttt{d8cddc613407455bec482cb6d7217072cc3a2d32}

    \item[Attachment 2: Grafana Dashboards] \hfill \\
    The JSON-exports of the Grafana dashboards used for visualizing hash slot assignments and key metrics during the scale-in phases. Located in the \texttt{/k8s-cluster/grafana/} directory.
