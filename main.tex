...
\def \myTitle{Die Kunst ein korrektes Deckblatt zu formatieren}
\def \mySubtitle{Ein anschauliches Beispiel}
\def \myStudy{Software and Digital Experience Engineering}
\def \myName{Kim Mustermensch, BSc}
\def \myAdvisor{DI Dr. Martina Musterfrau}
